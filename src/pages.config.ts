...
export const pagesConfig = {
  ...
  decisions: {
    ...
    description:
      "A log of architectural and technical decisions, documenting the context, alternatives considered, and reasoning behind key engineering choices.",
    heading: "Decisions",
    intro:
  ...
  journey: {
    ...
    description:
      "A chronological timeline of my professional journey, highlighting key milestones, learning moments, and career transitions that shaped my growth as an engineer.",
    heading: "Journey",
    intro:
      "A timeline of my professional growth and learning progression. This isn't a resume—it's a story of how I've evolved as an engineer, the pivotal moments that shaped my thinking, and the skills I've developed along the way.",
  },
  ...
  writing: {
    ...
    description:
      "Technical articles, insights, and lessons learned from building software systems and solving engineering challenges.",
    heading: "Writing",
    intro:
  ...
  speaking: {
    ...
    description:
      "Conference talks, meetup presentations, podcast appearances, and workshops on software engineering, architecture, and technical leadership.",
    heading: "Speaking",
    intro:
  ...
  uses: {
    ...
    description:
      "A comprehensive list of the tools, technologies, and environment I use for development work.",
    heading: "Uses",
    intro:
