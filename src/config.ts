...
export const siteConfig = {
   ...
   */
  title: getEnv("SITE_TITLE", "Personal Website"),
  ...
  description: getEnv(
    "SITE_DESCRIPTION",
    "Berlin-based Applied Scientist at Amazon with a PhD in Machine Learning, specializing in time-series forecasting, recommender systems, and large-scale decision models."
  ),
  ...
  author: {
    /** Full name */
    name: getEnv("SITE_AUTHOR_NAME", "Shayan Jawed"),

    /** Professional title or role */
    title: getEnv("SITE_AUTHOR_TITLE", "Applied Scientist"),
    ...
    email: getEnv("SITE_AUTHOR_EMAIL", "itzshayan@gmail.com"),
